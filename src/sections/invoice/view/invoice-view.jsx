...
import { ButtonGroup, Divider, Grid, Modal, Stack, TextField, Tooltip, Box } from '@mui/material';
        ...
        <Box sx={{
          ...
          <Grid container spacing={3} sx={{ marginTop: 2 }}>
            ...
            <Grid item xs={12} sm={6}>
              <Tooltip title="فیلد عنوان به سامانه ارسال نمیشود. برای تمایز بین صورت حساب ها در داشبورد از عنوان های معنا دار استفاده شود" arrow>
                <TextField
                  required
                  id="title"
                  name="title"
